...
class ThemeLabeler:
    ...
    FRENCH_STOPWORDS = {
        ...
        "dont", "où", "ce", "cela", "ça", "ceci",
        # Verbes auxiliaires
        "être", "avoir", "est", "sont", "était", "été", "a", "ai", "ont",
        "fait", "faire", "va", "vais", "vont", "peut", "peux", "peuvent",
        # Prépositions et conjonctions
        "à", "au", "aux", "avec", "dans", "pour", "par", "sur", "sous",
        "entre", "vers", "chez", "sans", "contre", "mais", "ou", "et",
        "donc", "or", "ni", "car", "si", "comme", "quand", "lorsque",
        # Adverbes courants
        "très", "bien", "mal", "plus", "moins", "aussi", "trop", "peu",
        "encore", "toujours", "jamais", "souvent", "parfois", "déjà",
        "alors", "puis", "ensuite", "enfin", "vraiment", "peut-être",
        # Mots d'entretien qualitatif
        "euh", "hein", "bon", "ben", "bah", "voilà", "donc", "alors",
        "oui", "non", "ouais", "nan", "ok", "d'accord", "effectivement",
        "interviewer", "intervieweur", "enquêteur", "question", "réponse",
        # Autres
        "tout", "tous", "toute", "toutes", "autre", "autres", "même",
        "chaque", "quelque", "quelques", "aucun", "aucune", "certain",
        "certains", "certaine", "certaines", "plusieurs", "beaucoup",
        "peu", "assez", "tellement",
    }
